...
public class MainPanel extends JPanel {
	...
	JButton changePwdButton = new JButton("ChangePwd");
	ChangePasswordAction changePassword = new ChangePasswordAction();
	changePwdButton.addActionListener(changePassword);
	...
	*/
	for (int i = 0; rpm != null && i < rpm.length; i++) {
		 ...
		 */
			switch(rpm[i]){
				case "View" : buttons.addElement(f3Button); break; //View Button
				case "Edit" : buttons.addElement(f4Button); break; //Edit Button
				case "Copy" : buttons.addElement(f5Button); break;//Copy Button
				case "Move" : buttons.addElement(f6Button); break;//Move Button
				case "Mkdir" : buttons.addElement(f7Button); break;//Mkdir Button
				case "AddUser" : buttons.addElement(addNewUser); break; //addUser Button
				case "ChangePassword" : buttons.addElement(changePwdButton); break; //changePwd Button
			}
	    //Add User
